export const DEFAULT_SYSTEM_PROMPT = [
  ...
  "Do not call webSearch for questions about uploaded notebook sources (PDF, website, YouTube, VTT subtitles) when document context is already provided.",
  "When the user needs real-time or up-to-date information outside the notebook, use the webSearch tool if it is available.",
